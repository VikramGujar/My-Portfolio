      ...
      <div className="container mx-auto px-6 lg:flex lg:justify-between lg:items-start">
        ...
        <div className="lg:w-1/3 mb-8 lg:mb-0">
          ...
          <div className="flex space-x-6">
            <a href="https://github.com/your-github" target="_blank" rel="noopener noreferrer" className="group">
              <FontAwesomeIcon icon={faGithub} size="2x" className="text-white group-hover:text-sky-500 transition duration-300 transform group-hover:scale-110" />
            </a>
            <a href="https://linkedin.com/in/your-linkedin" target="_blank" rel="noopener noreferrer" className="group">
            ...
            <a href="https://instagram.com/your-instagram" target="_blank" rel="noopener noreferrer" className="group">
              <FontAwesomeIcon icon={faInstagram} size="2x" className="text-white group-hover:text-sky-500 transition duration-300 transform group-hover:scale-110" />
            </a>
          </div>
        </div>
